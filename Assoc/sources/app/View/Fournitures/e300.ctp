...
<div class="row">
	<div class="col-md-12">
		...
		<table class="table table-striped">
			...
			<?php
					//echo '<td>' . /*$lignedebon[$i]['OptionNom']*/"Option" . '-' . /*$lignedebon[$i]['CoursNom']*/"Cours" . '</td>';
			?>
					<td>
						...
						<option value="<?php echo $lignedebon[$i]['CodeBarre']; ?>"><?php echo $lignedebon[$i]['CodeBarre']; ?></option>
						</select> 
					</td>
					<td>
