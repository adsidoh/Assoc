...
<h3>Création de votre espace association</h3>
<p>Les champs en <span style="color:red"> *</span> sont obligatoires</p>
<?php
...
<?php  
    ...
    echo $this->Form->input('PConseilFCPENom', array(
        ...
        'label' => array(
            ...
            'text' => 'Nom d\'association<span style="color:red">*</span>'
        )
    )); 
...
<?php  
    ...
    echo $this->Form->input('PSCNumEtVoie', array(
        ...
        'label' => array(
            'class' => 'col-sm-2 control-label',
            'text' => 'Numéro, Voie<span style="color:red">*</span>'
        )
    )); 
...
<?php
    ...
    echo $this->Form->input('PEtablissementNom', array(
        ...
        'label' => array(
            'class' => 'col-sm-2 control-label',
            'text' => 'Nom de l\'établissement <span style="color:red">*</span>'
        )
    ));
    ...
    echo $this->Form->input('PTypeDEtablissementNom', array(
        ...
        'label' => array(
            'class' => 'col-sm-2 control-label',
            'text' => 'Etablissement scolaire <span style="color:red">*</span>'
        )
    ));
